...
{#if loginRequired}
	<LoadingWrapper message={`Don't have an account. Please sign up to enjoy Urbanista articles`} />	
{:else if !loaded}
	...
	<section class="post">
		...
		<div class="post-interaction">
			<div class="post-interaction-left">
				...
				<span on:click={()=>liked=!liked} class="action-clickable {liked?'action-active':''}">
